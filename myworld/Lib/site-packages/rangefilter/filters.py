            ...
            (
                (
                    ...
                    forms.DateField(
                        ...
                        widget=AdminDateWidget(attrs={"placeholder": _("Từ ngày"),"id":_("tuNgay")}),
                        # het custom code 26-01-2024 
                        localize=True,
                        required=False,
                ...
                (
                    ...
                    forms.DateField(
                        label="",
                        widget=AdminDateWidget(attrs={"placeholder": _("Đến ngày"),"id":_("denNgay")}),
                        localize=True,
                        required=False,
